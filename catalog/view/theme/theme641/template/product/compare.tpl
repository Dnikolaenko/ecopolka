                                                    ...
                                                    <?php for ($i = 1; $i <= 5; $i++) { ?>
                                                        <?php if ($products[$product['product_id']]['rating'] < $i) { ?>
                                                            <span class="fa-stack"><i
                                                                    class="fl-bigmug-line-favourites5 fa-stack-2x"></i></span>
                                                        <?php } else { ?>
                                                            <span class="fa-stack"><i
                                                                    class="fl-bigmug-line-favourites5 fa-stack-2x"></i><i
                                                                    class="fl-bigmug-line-favourites5 star fa-stack-2x"></i></span>
                                                        <?php } ?>
                                                    <?php } ?>
